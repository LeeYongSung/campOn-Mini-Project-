  ...
  return (
    <>
        ...
        {/* <form action="/order/paymentpro" method="post" id="payForm"> */}
                                ...
                                <div className="py-2 paymentCount me-5">
                                    ...
                                    <div className="reservationNop_box d-flex form-floating ms-2">
                                        ...
                                        <input type="text" name="cartCnts" id="cartCnt" value={quantities[product.productNo]} 
                                            className="cartCnt form-control quantity" min={1} max={100} />
                                        <button className="countUp form-control" onClick={ () => onIncrease(product.productNo) }>+</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {campList != null && campList.map( (campList) => (
                <div className="container">
            ...
            <div className="w-100 text-end pe-2 py-3">
                <h4>총 렌트 금액 : <span>{totalPrice.toLocaleString()}원</span></h4>
            </div>


            {/* 결제하기 버튼 */}
            <button type="button" onClick={ () => handlePayment() } className="btn btn-lg btn-warning paymentBtn w-100 py-3 rounded-0">결제하기</button>
