...
const AdminProductAdd = () => {
    ...
    const [productThmFile, setProductThmFile] = useState('');
    const [productCategory, setProductCategory] = useState('');
    const [productPrice, setProductPrice] = useState('');
    const [productIntro, setProductIntro] = useState('');
    const [productConFile, setProductConFile] = useState('');
    ...
    const handleChange = (event) => {
        ...
        switch (name) {
            ...
            case 'productIntro':
                ...
                break;
            case 'productConFile':
                setProductConFile(value);
                break;
            case 'productImgs':
                setProductImgs(Array.from(event.target.files));
                break;
            default:
                break;
        }
    ...
    const handleSubmit = async () => {
        ...
        try {
            await admins.productAdd(product)
        } catch (error) {
            console.log(error)
        }
    }
