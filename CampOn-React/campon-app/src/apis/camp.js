...
//캠핑장목록
export const campproducts = (campTypeNo) => axios.get(`/api/camp/campproducts/${campTypeNo}`)
//캠핑장상세
...
export const campSearch = (keyword, searchDate, regionNo, checkBoxList) => axios.post("/api/camp/campSearch", {keyword, searchDate, regionNo, checkBoxList})
